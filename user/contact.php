    ...
    <div>
      <ul class="nav navbar-nav">
        ...
        <li><a href="feed.php">Feedbacks</a></li>
            ...
            <a href="searchreply.php" ><button style="background-color: #cccccc;border: none;width: 500px;position: absolute;left: 470px;top: 145px;" class="btn btn-lg btn-primary btn-block" type="submit">Search registered Contact's Remarks</button></a>
    <div class="container">
                <h2 style="margin-left:50px;">Enter contact information  and click 'Send' button.</h2>
                <form role="form" id="complaint" action="addcontact.php" method="POST">
