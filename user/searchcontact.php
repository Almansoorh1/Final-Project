...
<form role="form"action="show.php" method="POST" >
      ...
      <label for="srch">Enter your Contact ID Here:</label>
      <input type="search" name="search" class="form-control" id="srch" placeholder="Enter contact ID..." required autofocus>
    </div>
