...
<form role="form"action="showreply.php" method="POST" >
      <div class="form-group">
      <label for="srch">Enter your Complaint ID Here:</label>
      <input type="search" name="search" class="form-control" id="srch" placeholder="Enter complaint ID..." required autofocus>
    </div>
