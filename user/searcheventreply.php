      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="complaints.php">Complaints</a></li>
         <li><a href="contact.php">Contact Us</a></li>
            ...
            <form role="form"action="showeventreply.php" method="POST" >
      <div class="form-group">
      <label for="srch">Enter your Event ID Here:</label>
      <input type="search" name="srch" class="form-control" id="srch" placeholder="Enter Event ID..." required autofocus>
    </div>
